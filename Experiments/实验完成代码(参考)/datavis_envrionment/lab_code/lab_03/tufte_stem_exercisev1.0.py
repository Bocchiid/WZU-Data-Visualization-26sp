...
if direct_label:
    for field in fields:
        ...
        ax.text(2011.5, y_val, field, fontsize=12, va='center', 
...
# 实验任务
# ======================
st.markdown("## ✏️ 本次实验任务")
st.success("""
1. 从默认图表开始逐步优化
2. 开启关键标注后，使用位置微调滑块避免文字遮挡
3. 调整到布局清爽、配色和谐、信息清晰、整体美观
4. 记录每一步对应的Tufte原则
5. 另选一份数据，可视化并逐步改进
""")
